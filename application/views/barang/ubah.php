    ...
    <div class="card-body">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-4">
          ...
          <input type="text" class="form-control" min="1" name="harga_beli_barang" required value="<?php echo $barang['harga_beli_barang'] ?>">
        </div>
         <div class="col-md-4">
          <label>Harga Jual <small class="text-danger">*</small></label>
          <input type="text" class="form-control" min="1" name="harga_jual_barang" required value="<?php echo $barang['harga_jual_barang'] ?>">
        </div>
        <!-- <div class="col-md-4">
      ...
      <div class="form-group row">
       <!--  <div class="col-md-4">
          ...
          <input type="date" class="form-control" name="kadaluarsa_barang" min="<?php echo date("Y-m-d") ?>" required value="<?php echo $barang['kadaluarsa_barang'] ?>">
        </div>
        <div class="col-md-4">
          <label>Stok Obat <small class="text-danger">*</small></label>
          <input type="text" class="form-control" name="stok_barang" min="0" required value="<?php echo $barang['stok_barang'] ?>">
        </div> -->
         <div class="col-md-4">
          ...
          <select name="id_unit" class="form-control" required>
            ...
            <?php foreach ($unit as $key => $value): ?>
              <option <?php echo ($value['id_unit'] == $barang['id_unit']) ? 'selected' : '' ?> value="<?php echo $value['id_unit'] ?>"><?php echo $value['nama_unit'] ?></option>
            <?php endforeach ?>
          </select>
        </div>
         <!-- KATEGORI -->
        <div class="col-md-4">
          ...
          <select name="id_kategori" class="form-control" required>
            ...
            <?php foreach ($kategori as $key => $value): ?>
              <option <?php echo ($value['id_kategori'] == $barang['id_kategori']) ? 'selected' : '' ?> value="<?php echo $value['id_kategori'] ?>"><?php echo $value['nama_kategori'] ?></option>
            <?php endforeach ?>
          </select>
        </div>        
        <!-- ./KATEGORI -->
        ...
        <!-- <div class="col-md-4">
          ...
          <select name="id_pemasok" class="form-control" required>
            ...
            <?php foreach ($pemasok as $key => $value): ?>
              <option <?php echo ($value['id_pemasok'] == $barang['id_pemasok']) ? 'selected' : '' ?> value="<?php echo $value['id_pemasok'] ?>"><?php echo $value['nama_pemasok'] ?></option>
            <?php endforeach ?>
          </select>
        </div> -->
        <!-- ./PEMASOK -->
      ...
      <!--   <div class="col-md-4">
          ...
          <select name="id_lokasi" class="form-control" required>
            ...
            <?php foreach ($lokasi as $key => $value): ?>
              <option <?php echo ($value['id_lokasi'] == $barang['id_lokasi']) ? 'selected' : '' ?> value="<?php echo $value['id_lokasi'] ?>"><?php echo $value['nama_lokasi'] ?></option>
            <?php endforeach ?>
          </select>
        </div> -->
        <!-- ./Lokasi -->
